...
values ((select id from users where user_name = 'courtnie'), 'Jet Powered Volkswagen Beetle', '--Yes this is a real ad, and yes I used the photos everyone has seen from my website and shared. The last photo on this ad hasn''t been posted anywhere and shows the lift I store it on. I take it down once and a while and run it. Again, this is a real ad for the world famous jet powered Beetle.', '2021-09-03 14:00:45'),
       ((select id from users where user_name = 'courtnie'), 'IKEA Lamp', 'Let''s be real, it''s a dark time. You may find yourself wondering whether there''s a light ahead. I have great news, there is.
...
It''s gray but produces light that contains almost all, if not all, the colors of the rainbow. Will include additional colors on other spectrums of light upon buyers request.', '2021-09-06 12:45:03'),
       ((select id from users where user_name = 'courtnie'), 'Carolina Hurricanes Organ', 'Theater Organ - 1997 Rodgers Model 360 Organ
...
$7995.00 Make Offer', '2021-09-10 10:45:03'),
       ((select id from users where user_name = 'courtnie'), 'Unique challenge for experienced director - PAID', 'I am in search of an experienced director to tackle a unique challenge. My seven year old son is an up and coming film director, and I have decided that he is ready to direct his first feature film. His father has agreed to fund a film up to $250,000, so I''m looking for an experienced director to guide him through the process. He will be making all creative decisions, but he will need help and guidance.
...
Thank you for your time.', '2021-09-12 22:03:42'),
       ((select id from users where user_name = 'courtnie'), 'Apple Macintosh SE STONE CASTING', 'Apple Macintosh 512/Plus/SE Stone Casting
...
Serious MAC inquiries only.', '2021-09-15 20:03:02'),
       ((select id from users where user_name = 'aarion'), 'To the surfers who saved my life at Linda Mar 7/13', 'I don''t know who you are or how to locate you, but you literally saved my life. I want to thank you.
...
Stay Stoked!', '2021-07-14 16:00:04'),
       ((select id from users where user_name = 'aarion'), 'Space Cruiser (Rick and Morty)', 'This is a heavily used Space Cruiser coupe.
1 owner. Non-smoker (but heavy drinker)
Odometer: 11.3.14159265359 parsecs Does not run. Sold AS IS.', '2021-09-08 07:13:52'),
       ((select id from users where user_name = 'aarion'), 'Open letter to the person who called the police!', 'Where do I begin? First off thank you. Thanks for being in right place at the right time and doing the right thing.
...
His wife.', '2021-09-09 17:30:02'),
       ((select id from users where user_name = 'aarion'), 'Spot in lineup', 'Looking to bow out of the surf scene. Offering up a spot in the pecking order it''s well below Marty but way above a Mollusk guy. Can give more details in person. (No low ballers Koa)', '2021-09-10 16:36:42'),
       ((select id from users where user_name = 'aarion'), 'Full Size Wax Figures Dressed in Amish Wardrobe', 'Selling 40 full-sized wax figures/vinyl in Amish wardrobe from the Amish Farm and House tourist attraction. Originally from the Lancaster Wax Museum in a barn raising scene. Mostly all of them believed to be made by Dorfman Museum Figures out of Baltimore. The infant has a stamp from a different manufacturer.
Varying sizes, ages and details on these figures. The wardrobe can be exchanged to suit your historical or theatrical needs. There are 5 female figures, 3 children figures, about 32 male figures and 1 dog. Five of the men are mechanical. The dog is mechanical as well. Varying conditions. The parts are removable and some are disassembled but can be assembled for viewing.$1500 for anamatronic figure, $350-For full-sized adults, $300-Children/Dog. Hoping to sell as a set. Only Reasonable offers and Serious Buyers Please.', '2021-09-15 2:53:13'),
       ((select id from users where user_name = 'telvin'), 'BEAUTIFUL COMBINATION FIREPLACE / 8-TRACK STEREO!', 'This amazing combination fake fireplace / phonograph / FM stereo / 8-TRACK-PLAYER! could be yours FOR THE ABSOLUTELY FREE PRICE OF $FREE$!!!
...
Imagine the warmth and beauty it will bring to your stark and cold home. The stereo plays TODAYS HITS from LOCAL FM STATIONS while the fake firelog emits WARMING RAYS in the VISIBLE SPECTRUM!', '2021-09-05 12:35:33'),
       ((select id from users where user_name = 'telvin'), '1971 Cadillac Hearse Superior', '1971 Cadillac Hearse Superior For Sale!
...
$6,500 Cash. NO TRADES!', '2021-09-09 13:33:33'),
       ((select id from users where user_name = 'telvin'), 'for sale snow cat limo', 'for sale snow cat limo , sv 250 bombardier snow cat combined with 1989 caddy stretch limo. Last used 2 years ago.', '2021-09-12 10:53:03'),
       ((select id from users where user_name = 'telvin'), 'Slow car/huge cargo bike for burning man', 'Hello bicycle weirdo!
...
', '2021-09-13 22:33:37'),
       ((select id from users where user_name = 'telvin'), 'Big Framed Art Angel Print With Hamburger Thoughts', 'This print is absolutely huge. It''s 56 in Long 1 inch thick and 40 in tall.', '2021-09-15 08:37:17'),
       ((select id from users where user_name = 'michael'), 'Nothing!', 'I have absolutely nothing for sale! Don''t delay. Act now. Supplies are running out.', '2021-01-01 00:00:00'),
       ((select id from users where user_name = 'michael'), 'Full size replica doctor who dalek', 'Hand made 1970s full size doctor who dalek,made from original BBC doctor who drawings, moving arms, head and eye. Built in 3 parts so easy to transport with caster wheels on the base for easy moving.', '2021-02-22 00:00:00'),
       ((select id from users where user_name = 'michael'), 'Toilet paper seeds', 'Here you can see 2 toilet paper seeds, in their natural habitat, these are the best quality and are guaranteed to produce 3 ply paper for years to come if cultivated properly.', '2021-04-01 04:01:00'),
       ((select id from users where user_name = 'michael'), 'Moving On is Hard To Do Sale (June 15)', '*Photos 2-6 are stock photos of actual items for sale* Queen Size Casper Mattress: No sex was had in this bed. I bought it at the beginning of my year of celibacy. I didn''t know back then it would be a year; no one knows how long things will last when they''re just starting. No dating, no sex, no one, one year. I had beautiful dreams in this bed, dreams about flying, about shooting through the air, and leaving this city behind me, dreams about landing in a foreign place where no one would know my name. And when I woke up, I believed that maybe I could start over with another someone who was capable of loving me like I deserved to be loved. Anyway, this mattress has no stains, no damage, and the tears have dried :)', '2021-06-15 14:51:30'),
       ((select id from users where user_name = 'michael'), 'New Holiday proposed', 'America needs a new Holiday!! A Day where one can be genuinely content, happy, and calm. The Holiday name is: Ain''t nobody mad at me day. A day where politics, police, boss, landlord, ex girlfriend,ex boyfriend, ex spouse, pet, co-worker, Bill collector, bartender,parents,kids,or any other authority that claims control of one''s time is not at odds with you.
...
Feel free to share this post😊', '2021-07-25 15:59:38'),
       ((select id from users where user_name = 'bob'), '1979 DODGE "STAR WARS" VAN, ORIGINAL SURVIVOR!', 'From a galaxy in a garage from far far away....I offer you the ultimate Star Wars van.
...
Holiday Themed. Recreate the classical off-broadway play STOMP at home! Or just carry stuff in them. The future is yours.', '2021-09-3 12:12:12'),
       ((select id from users where user_name = 'bob'), 'bob''s burgers hamburger landline phone', 'Even if you''re not inspired by the beloved Beltcher family, who wouldn''t want to live in the magical world where your phone is shaped like your favorite food?!?
